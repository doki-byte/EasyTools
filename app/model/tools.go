...
func (s *Tools) Initialize(db *gorm.DB) {
	...
	if count == 0 {
		defaultTools := []Tools{
			{Category: "命令测试", Cmd: "whoami", Param: "", Name: "whoami", Path: "", Desc: "终端命令显示", Icon: "", Terminal: 1, CateSort: 0, CmdSort: 0},
			{Category: "命令测试", Cmd: "calc", Param: "", Name: "弹计算器", Path: "", Desc: "不显示终端框框", Icon: "", Terminal: 0, CateSort: 0, CmdSort: 0},
		}
