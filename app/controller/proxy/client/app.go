...
import (
	...
	request2 "EasyTools/app/controller/proxy/request"
	"bufio"
	"context"
	"fmt"
...
func NewProxy() *Proxy {
	return &Proxy{
		...
		rpm: request2.NewProxyManager([]request2.ProxyFetcher{
			//&request.Free89,
			//&request.FreeHappy,
			//&request.FreeQiYun,
			&request2.HunterConfig{},
			&request2.QuakeConfig{},
			&request2.FofaConfig{},
		}),
	}
}
