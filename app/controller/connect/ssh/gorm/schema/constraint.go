...
func (chk *CheckConstraint) Build() (sql string, vars []any) {
	return "CONSTRAINT ? CHECK (?)", []any{clause2.Column{Name: chk.Name}, clause2.Expr{SQL: chk.Constraint}}
}
...
func (uni *UniqueConstraint) Build() (sql string, vars []any) {
	return "CONSTRAINT ? UNIQUE (?)", []any{clause2.Column{Name: uni.Name}, clause2.Column{Name: uni.Field.DBName}}
}
