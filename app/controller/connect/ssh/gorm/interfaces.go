...
type Dialector interface {
	...
	DefaultValueOf(*schema.Field) clause2.Expression
	BindVarTo(writer clause2.Writer, stmt *Statement, v any)
	QuoteTo(clause2.Writer, string)
...
type Valuer interface {
	GormValue(context.Context, *DB) clause2.Expr
}
