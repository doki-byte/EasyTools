...
import (
	...
	"EasyTools/app/controller/connect/ssh/gin/sessions/context"
...
func Sessions(name string, store Store) gin2.HandlerFunc {
...
func SessionsMany(names []string, store Store) gin2.HandlerFunc {
	return func(c *gin2.Context) {
...
func (s *session) Session() *sessions2.Session {
	if s.session == nil {
		var err error
...
func Default(c *gin2.Context) Session {
	return c.MustGet(DefaultKey).(Session)
}

// shortcut to get session with given name
func DefaultMany(c *gin2.Context, name string) Session {
