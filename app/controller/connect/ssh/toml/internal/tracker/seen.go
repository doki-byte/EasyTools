...
func (s *SeenTracker) CheckExpression(node *unstable2.Node) (bool, error) {
	if s.entries == nil {
		s.reset()
	}
	switch node.Kind {
...
func (s *SeenTracker) checkTable(node *unstable2.Node) (bool, error) {
	if s.currentIdx >= 0 {
...
func (s *SeenTracker) checkArrayTable(node *unstable2.Node) (bool, error) {
	if s.currentIdx >= 0 {
		s.setExplicitFlag(s.currentIdx)
	}
...
func (s *SeenTracker) checkKeyValue(node *unstable2.Node) (bool, error) {
...
func (s *SeenTracker) checkArray(node *unstable2.Node) (first bool, err error) {
	it := node.Children()
	for it.Next() {
		n := it.Node()
		switch n.Kind {
...
func (s *SeenTracker) checkInlineTable(node *unstable2.Node) (first bool, err error) {
	if pool.New == nil {
		pool.New = func() any {
			return &SeenTracker{}
		}
