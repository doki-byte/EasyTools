...
func RegisterExtensionStatVFS() {
	sshfx2.RegisterExtendedPacketType(extensionStatVFS, func() sshfx2.ExtendedData {
...
func ExtensionStatVFS() *sshfx2.ExtensionPair {
...
func (ep *StatVFSExtendedPacket) Type() sshfx2.PacketType {
...
func (ep *StatVFSExtendedPacket) MarshalInto(buf *sshfx2.Buffer) {
...
func (ep *StatVFSExtendedPacket) UnmarshalFrom(buf *sshfx2.Buffer) (err error) {
...
func RegisterExtensionFStatVFS() {
	sshfx2.RegisterExtendedPacketType(extensionFStatVFS, func() sshfx2.ExtendedData {
...
func ExtensionFStatVFS() *sshfx2.ExtensionPair {
	return &sshfx2.ExtensionPair{
...
// Type returns the SSH_FXP_EXTENDED packet type.
func (ep *FStatVFSExtendedPacket) Type() sshfx2.PacketType {
	return sshfx2.PacketTypeExtended
}
...
// MarshalInto encodes ep into the binary encoding of the statvfs@openssh.com extended packet-specific data.
func (ep *FStatVFSExtendedPacket) MarshalInto(buf *sshfx2.Buffer) {
	buf.AppendString(ep.Path)
}
...
// UnmarshalFrom decodes the statvfs@openssh.com extended packet-specific data into ep.
func (ep *FStatVFSExtendedPacket) UnmarshalFrom(buf *sshfx2.Buffer) (err error) {
...
func (ep *StatVFSExtendedReplyPacket) Type() sshfx2.PacketType {
	return sshfx2.PacketTypeExtendedReply
}
...
func (ep *StatVFSExtendedReplyPacket) UnmarshalPacketBody(buf *sshfx2.Buffer) (err error) {
	p := &sshfx2.ExtendedReplyPacket{
		Data: ep,
	}
...
func (ep *StatVFSExtendedReplyPacket) MarshalInto(buf *sshfx2.Buffer) {
...
func (ep *StatVFSExtendedReplyPacket) MarshalBinary() ([]byte, error) {
	...
	b := sshfx2.NewBuffer(make([]byte, 0, size))
	ep.MarshalInto(b)
	return b.Bytes(), nil
}

// UnmarshalFrom decodes the fstatvfs@openssh.com extended reply packet-specific data into ep.
func (ep *StatVFSExtendedReplyPacket) UnmarshalFrom(buf *sshfx2.Buffer) (err error) {
