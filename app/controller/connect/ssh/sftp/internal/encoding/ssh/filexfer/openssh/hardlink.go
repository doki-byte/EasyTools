...
func RegisterExtensionHardlink() {
	sshfx2.RegisterExtendedPacketType(extensionHardlink, func() sshfx2.ExtendedData {
...
func ExtensionHardlink() *sshfx2.ExtensionPair {
...
func (ep *HardlinkExtendedPacket) Type() sshfx2.PacketType {
...
func (ep *HardlinkExtendedPacket) MarshalInto(buf *sshfx2.Buffer) {
...
func (ep *HardlinkExtendedPacket) UnmarshalFrom(buf *sshfx2.Buffer) (err error) {
