...
func ConfCreate(c *gin2.Context) {
...
func ConfFindByID(c *gin2.Context) {
...
func ConfFindAll(c *gin2.Context) {
...
func ConfUpdateById(c *gin2.Context) {
	var config model.SshConf
	if err := c.ShouldBind(&config); err != nil {
		c.JSON(200, gin2.H{"code": 1, "msg": err.Error()})
		return
...
func ConfDeleteById(c *gin2.Context) {
	id, err := strconv.Atoi(c.Param("id"))
	if err != nil {
		c.JSON(200, gin2.H{"code": 2, "msg": err.Error()})
		return
